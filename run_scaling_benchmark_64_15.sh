...
INPUT_FILE="input_64_15_Re1000.nml"
OUTPUT_CSV="scaling_results_64_15.csv"
MAX_THREADS=16
BASELINE_OUTPUT_FILE="cavity_run_64_15_Re1000_1_threads.dat"
...
echo "Starting OpenMP scaling benchmark for '$EXECUTABLE' with input '$INPUT_FILE'..."
...
do
    ...
    OUTPUT_FILE="cavity_run_64_15_Re1000_${threads}_threads.dat"
...
do
    CURRENT_OUTPUT_FILE="cavity_run_64_15_Re1000_${threads}_threads.dat"
    ...
    if ! diff -q "$BASELINE_OUTPUT_FILE" "$CURRENT_OUTPUT_FILE"; then
...
if [ "$all_verified" = true ]; then
     ...
     for (( threads=2; threads<=MAX_THREADS; threads++ )); do
        rm "cavity_run_64_15_Re1000_${threads}_threads.dat"
     done
     # Rename the baseline for clarity
     mv "$BASELINE_OUTPUT_FILE" "cavity_run_64_15_Re1000_OMP_verified.dat"
     echo "Final verified output saved as: cavity_run_64_15_Re1000_OMP_verified.dat"
else
